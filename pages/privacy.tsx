  ...
  return (
    <>
      <Container>
        ...
        <Text as="p" variant="paragraph">
          This policy is effective as of 19 January 2022 and was last updated on
          19 January 2022.{" "}
        </Text>
        ...
        <ul>
          ...
          <Text as="li">Email</Text>
          <Text as="li">Slack workspace details</Text>
        </ul>
        <Text as="h4" variant="heading">
        ...
        <ul>
          ...
          <Text as="li">When you mention us on social media</Text>
        </ul>
        <Text as="p" variant="paragraph">
        ...
        <ul>
          ...
          <Text as="li">to contact and communicate with you</Text>
        </ul>
        <Text as="p" variant="paragraph">
        ...
        <ul>
          <Text as="li">a parent, subsidiary, or affiliate of our company</Text>
          <Text as="li">
